...
const socials = [
  ...
  { icon: <GithubIcon size={18} />, label: 'GITHUB', value: 'github.com/kikiaimarwicaksana', href: 'https://github.com/kikiaimarwicaksana' },
  { icon: <LinkedinIcon size={18} />, label: 'LINKEDIN', value: 'linkedin.com/in/kikiaimarwicaksana', href: 'https://linkedin.com/in/kikiaimarwicaksana' },
];
